document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18nData = {
        "ko": {
            ...
            "proto-desc-1": "시스템이 플레이어를 낙원 공간으로 초기화합니다.",
            "proto-desc-2": "시스템은 이상 행동을 감지하고 교정을 시도합니다.",
            "proto-desc-3": "기억 조작을 통해 현신 인식을 통제합니다.",
            "proto-desc-4": "관계와 환경을 왜곡하여 의심과 공포를 증폭합니다.",
            "proto-desc-5": "관찰 시스템이 붕괴하며 통제가 무너집니다.",
            "proto-desc-6": "탈출을 시도하면 낙원은 적대적 본능으로 전환합니다.",
        ...
        "en": {
            ...
            "platforms-title": "PLATFORMS",
            "protocols-title-main": "CORE PROTOCOLS",
            "proto-desc-1": "The system initializes the player into the paradise space.",
            "proto-desc-2": "The system detects abnormal behavior and attempts correction.",
            "proto-desc-3": "Controls reality perception through memory manipulation.",
            "proto-desc-4": "Amplifies suspicion and fear by distorting relationships and environments.",
            "proto-desc-5": "Control collapses as the observatory system breaks down.",
            "proto-desc-6": "If escape is attempted, the paradise switches to hostile instincts.",
            "tag-fear-principle": "FEAR OPERATING PRINCIPLE",
